...
if has_south:
    ...
    add_introspection_rules([], ["^artminster\.contrib\.smart_selects\.db_fields\.ChainedForeignKey"])
    add_introspection_rules(rules_grouped, ["^artminster\.contrib\.smart_selects\.db_fields\.GroupedForeignKey"])
