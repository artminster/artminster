...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserSubscription.last_reset_date'
        db.add_column('billing_usersubscription', 'last_reset_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserSubscription.last_reset_date'
        db.delete_column('billing_usersubscription', 'last_reset_date')
    ...
    models = {
        ...
        'billing.usersubscription': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'last_reset_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
