...
tinyMCE.init({
    ...
    // elements
    /*valid_elements : [
        '-p,','a[href|target=_blank|class]','-b/-strong','-em/-i','-u','-ol',
        '-ul','-li','br','img[class|src|alt=|width|height]','-h1,-h2,-h3,-h4','-pre','-blockquote','-code','-div'
    ].join(','),
    ...
    valid_children : [
        'body[h1|h2|h3|p|ul|a]', 'p[span|a|#text|ul|strong]', 'ul[li]', 'li[a|#text]', 'a[img|#text]'
    ].join(',')*/
